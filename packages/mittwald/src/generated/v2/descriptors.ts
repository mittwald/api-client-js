...
export const domainGenerateFromInput: OpenAPIOperation<
  RequestType<
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Parameters.RequestBody>,
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Parameters.Path>,
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Parameters.Query>,
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Parameters.Header>
  >,
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Responses.$200.Content.ApplicationJson>,
      200,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Responses.$400.Content.ApplicationJson>,
      400,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Responses.$412.Content.ApplicationJson>,
      412,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerate.Post.Responses.Default.Content.ApplicationJson>,
      "default",
      "application/json"
    >
> = {
...
export const domainGenerateInContext: OpenAPIOperation<
  RequestType<
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Parameters.RequestBody>,
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Parameters.Path>,
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Parameters.Query>,
    Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Parameters.Header>
  >,
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Responses.$200.Content.ApplicationJson>,
      200,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Responses.$400.Content.ApplicationJson>,
      400,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Responses.$412.Content.ApplicationJson>,
      412,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2DomainsGenerateInContext.Post.Responses.Default.Content.ApplicationJson>,
      "default",
      "application/json"
    >
> = {
...
export const extensionGetPublicKey: OpenAPIOperation<
  RequestType<
    Simplify<null>,
    Simplify<MittwaldAPIV2.Paths.V2WebhookPublicKeysSerial.Get.Parameters.Path>,
    Simplify<MittwaldAPIV2.Paths.V2WebhookPublicKeysSerial.Get.Parameters.Query>,
    Simplify<MittwaldAPIV2.Paths.V2WebhookPublicKeysSerial.Get.Parameters.Header>
  >,
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2WebhookPublicKeysSerial.Get.Responses.$200.Content.ApplicationJson>,
      200,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2WebhookPublicKeysSerial.Get.Responses.$404.Content.ApplicationJson>,
      404,
      "application/json"
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2WebhookPublicKeysSerial.Get.Responses.Default.Content.ApplicationJson>,
      "default",
      "application/json"
    >
> = {
...
export const orderCreateOrder: OpenAPIOperation<
  ...
  | Response<
    ...
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2Orders.Post.Responses.$403.Content.ApplicationJson>,
      403,
      "application/json"
    >
  | Response<
...
export const userInitPasswordReset: OpenAPIOperation<
  ...
  | Response<
    ...
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2UsersSelfCredentialsActionsInitPasswordReset.Post.Responses.$403.Content.ApplicationJson>,
      403,
      "application/json"
    >
  | Response<
...
export const userRegister: OpenAPIOperation<
  ...
  | Response<
    ...
    >
  | Response<
      Simplify<MittwaldAPIV2.Paths.V2Register.Post.Responses.$403.Content.ApplicationJson>,
      403,
      "application/json"
    >
  | Response<
