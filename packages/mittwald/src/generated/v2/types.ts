...
export declare module MittwaldApiV2 {
  namespace Paths {
    ...
    namespace V2_Articles_ArticleId_Orderable {
      namespace Get {
        namespace Parameters {
          interface Path {
            articleId: string;
    ...
    namespace V2_Articles_Orderable {
      namespace Get {
        namespace Parameters {
          interface Query {
            customerId?: string;
    ...
    namespace V2_Projects_ProjectId_Projectbackups {
      namespace Post {
        namespace Parameters {
          interface Path {
            projectId: string;
    ...
    namespace V2_Projects_ProjectId_Schedules {
      namespace Post {
        namespace Parameters {
          interface Path {
            projectId: string;
        ...
        namespace Responses {
          namespace $201 {
            namespace Content {
              type Application_Json =
                MittwaldApiV2.Components.Schemas.De_Mittwald_V1_Backup_BackupSchedule;
            }
          }
    ...
    namespace V2_Projectbackups_BackupId {
      namespace Delete {
        namespace Parameters {
          interface Path {
            backupId: string;
    ...
    namespace V2_Projectbackups_BackupId_Export {
      namespace Delete {
        namespace Parameters {
          interface Path {
            backupId: string;
    ...
    namespace V2_Backupschedules_ScheduleId {
      namespace Delete {
        namespace Parameters {
          interface Path {
            scheduleId: string;
    ...
    namespace V2_Backupschedules_ScheduleId_Ttl {
      namespace Put {
        namespace Parameters {
          interface Path {
            scheduleId: string;
    ...
    namespace V2_Projectbackups_BackupId_Description {
      namespace Put {
        namespace Parameters {
          interface Path {
            backupId: string;
    ...
    namespace V2_Contracts_ContractId_BaseItem {
      namespace Get {
        namespace Parameters {
          interface Path {
            contractId: string;
    ...
    namespace V2_Cronjobs_CronjobId_Executions_ExecutionId_Abort {
      namespace Post {
        namespace Parameters {
          interface Path {
            cronjobId: string;
    ...
    namespace V2_Invites_Customers_CustomerId_Specific_InviteId {
      namespace Get {
        namespace Parameters {
          interface Path {
            inviteId: string;
    ...
    namespace V2_Invites_Projects_ProjectId_Specific_InviteId {
      namespace Get {
        namespace Parameters {
          interface Path {
            inviteId: string;
    ...
    namespace V2_Projects_ProjectId_Users_UserId_Membership {
      namespace Get {
        namespace Parameters {
          interface Path {
            userId: string;
    ...
    namespace V2_Invites_Customers {
      namespace Get {
        namespace Parameters {
          interface Query {
            emailAddress?: string;
    ...
    namespace V2_Placementgroups_PlacementGroupId_Avatar {
      namespace Delete {
        namespace Parameters {
          interface Path {
            placementGroupId: string;
    ...
    namespace V2_Placementgroups_PlacementGroupId {
      namespace Get {
        namespace Parameters {
          interface Path {
            placementGroupId: string;
        ...
        namespace Responses {
          namespace $200 {
            namespace Content {
              type Application_Json =
                MittwaldApiV2.Components.Schemas.De_Mittwald_V1_Project_PlacementGroup;
            }
          }
    ...
    namespace V2_Placementgroups_PlacementGroupId_Projects {
      namespace Post {
        namespace Parameters {
          interface Path {
            placementGroupId: string;
    ...
    namespace V2_Projects_ProjectId_Storage {
      namespace Get {
        namespace Parameters {
          interface Path {
            projectId: string;
  ...
  namespace Components {
    namespace Schemas {
      ...
      interface De_Mittwald_V1_Backup_BackupSchedule {
        backupTtl?: string;
        createdAt?: string;
        description?: string;
        id: string;
      ...
      interface De_Mittwald_V1_Backup_Export {
        downloadURL?: string;
        expiresAt?: string;
        format: string;
        phase?:
      ...
      interface De_Mittwald_V1_Backup_ProjectBackup {
        ...
        description?: string;
        expiresAt?: string;
        export?: MittwaldApiV2.Components.Schemas.De_Mittwald_V1_Backup_Export;
        id: string;
        parentId?: string;
        projectId: string;
        status: string;
      ...
      interface De_Mittwald_V1_Contract_Address {
        city: string;
        countryCode: string;
        houseNumber: string;
        street: string;
      ...
      interface De_Mittwald_V1_Contract_Contact {
        address: MittwaldApiV2.Components.Schemas.De_Mittwald_V1_Contract_Address;
        company?: string;
        emailAddress?: string;
        firstName?: string;
        lastName?: string;
      ...
      interface De_Mittwald_V1_Customer_Address {
        city: string;
        countryCode: string;
        houseNumber: string;
        street: string;
      ...
      interface De_Mittwald_V1_Customer_Contact {
        address: MittwaldApiV2.Components.Schemas.De_Mittwald_V1_Customer_Address;
        company?: string;
        emailAddress?: string;
        firstName?: string;
        lastName?: string;
        phoneNumbers?: string[];
        salutation: "male" | "female" | "hello";
        title?: string;
        useFormalTerm?: boolean;
      }
      ...
      interface De_Mittwald_V1_Datev_ExportFile {
        exportId: string;
        exportedAt: string;
        fileIds: string[];
      ...
      type De_Mittwald_V1_Domain_ProcessState = "REQUESTED" | "FAILED";
      ...
      interface De_Mittwald_V1_Invoice_Address {
        city: string;
        countryCode: string;
        houseNumber: string;
        street: string;
      ...
      interface De_Mittwald_V1_Invoice_Dummy {
        errorProps: {};
        errorReason: string;
      }
      ...
      interface De_Mittwald_V1_Invoice_Invoice {
        ...
        pdfId: string;
        recipient: MittwaldApiV2.Components.Schemas.De_Mittwald_V1_Invoice_Recipient;
        status: "NEW" | "CONFIRMED" | "DENIED" | "PAID" | "PARTIALLY_PAID";
        totalGross: number;
        totalNet: number;
        vatId?: string;
      }
      ...
      interface De_Mittwald_V1_Invoice_Recipient {
        address: MittwaldApiV2.Components.Schemas.De_Mittwald_V1_Invoice_Address;
        company?: string;
        emailAddress?: string;
        firstName?: string;
        lastName?: string;
      ...
      interface De_Mittwald_V1_Invoice_Reference {
        id: string;
        type: number;
      }
      ...
      interface De_Mittwald_V1_Project_PlacementGroup {
        customerId: string;
        description: string;
        id: string;
        imageRefId?: string;
