...
const buildContainerApi = (baseClient: MittwaldAPIV2Client) => ({
  ...
  getContainerImageMeta: new ApiCallAsyncResourceFactory(
    descriptors.containerGetContainerImageMeta,
    baseClient.container.getContainerImageMeta,
  ).getApiResource,
  /** Get a Container belonging to a Stack. */
  getContainer: new ApiCallAsyncResourceFactory(
    descriptors.containerGetContainer,
    baseClient.container.getContainer,
  ).getApiResource,
  /** Get a Stack. */
  ...
  listContainers: new ApiCallAsyncResourceFactory(
    descriptors.containerListContainers,
    baseClient.container.listContainers,
  ).getApiResource,
