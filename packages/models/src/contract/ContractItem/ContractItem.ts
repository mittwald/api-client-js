...
import { ContractItemArticleDetailed } from "../ContractItemArticle/index.js";
...
export class ContractItemDetailed extends ContractItemCommon {
  public readonly articles: ContractItemArticleDetailed[];
  ...
  public constructor(contractId: string, data: ContractItemData) {
    ...
    this.articles = data.articles.map(
      (articleData) =>
        new ContractItemArticleDetailed(contractId, this.id, articleData),
    );
  }
}
