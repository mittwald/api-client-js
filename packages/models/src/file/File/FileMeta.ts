...
export class FileMeta extends ReferenceModel {
  ...
  public findDetailed = provideReact(
    () => FileMeta.find(this.file),
    [this.id],
  ) as AsyncResourceVariant<() => Promise<FileMetaDetailed | undefined>>;

  public getDetailed = provideReact(
    () => FileMeta.get(this.file),
    [this.id],
  ) as AsyncResourceVariant<() => Promise<FileMetaDetailed>>;
}
