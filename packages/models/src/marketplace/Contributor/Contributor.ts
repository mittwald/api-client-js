...
export class Contributor extends ReferenceModel {
  public readonly incomingInvoices: ContributorIncomingInvoiceListQuery;
  ...
  public static query(query: ContributorListQueryData = {}) {
...
class ContributorCommon extends classes(
  DataModel<ContributorListItemData | ContributorData>,
  Contributor,
) {
