...
import { apiContractTerminationBehaviors } from "../../contract/ContractTermination/behaviors/index.js";
...
class ApiSetupState {
  ...
  public setupWithClient(client: MittwaldAPIV2Client) {
    ...
    config.behaviors.contractTermination =
      apiContractTerminationBehaviors(client);
  }
