...
import { apiSystemSoftwareBehaviors } from "../../app/SystemSoftwareVersion/behaviors/index.js";
...
class ApiSetupState {
  ...
  public setupWithClient(client: MittwaldAPIV2Client) {
    ...
    config.behaviors.systemSoftwareVersion = apiSystemSoftwareBehaviors(client);
  }
