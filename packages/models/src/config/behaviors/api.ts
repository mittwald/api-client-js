...
import { apiContractItemTerminationBehaviors } from "../../contract/ContractItemTermination/behaviors/index.js";
...
class ApiSetupState {
  ...
  public setupWithClient(client: MittwaldAPIV2Client) {
    ...
    config.behaviors.contractItemTermination =
      apiContractItemTerminationBehaviors(client);
  }
