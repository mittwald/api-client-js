...
import { ContractItemTerminationBehaviors } from "../contract/ContractItemTermination/behaviors/index.js";
...
interface Config {
  ...
  behaviors: {
    ...
    contractItemTermination: ContractItemTerminationBehaviors;
...
export const config: Config = {
  ...
  behaviors: {
    ...
    contractItemTermination:
      undefined as unknown as ContractItemTerminationBehaviors,
