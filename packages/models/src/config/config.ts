...
import { ContractItemDependenciesBehaviors } from "../contract/ContractItemDependencies/behaviors/index.js";
...
interface Config {
  ...
  behaviors: {
    ...
    contractItemDependencies: ContractItemDependenciesBehaviors;
...
export const config: Config = {
  ...
  behaviors: {
    ...
    contractItemDependencies:
      undefined as unknown as ContractItemDependenciesBehaviors,
